...
export default function FocusTimer() {
  ...
  const startPause = () => {
    if (isRunning) {
      ...
      if (secondsLeft === 0) setSecondsLeft(30 * 60); 
      setIsRunning(true);
    }
  };
  ...
  return (
    <div className="bg-white rounded-xl shadow p-4 max-w-xs mx-auto text-center">
      ...
      <div className="text-4xl font-mono mb-4 text-blue-600">{formatTime(secondsLeft)}</div>
      <div className="flex justify-center space-x-4">
        ...
        <button
          onClick={reset}
          className="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 transition"
        >
          Reset
        </button>
      </div>
